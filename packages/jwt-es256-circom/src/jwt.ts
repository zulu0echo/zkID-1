...
import { stringToPaddedBigIntArray } from './utils.ts';
...
export function generateJwtInputs(params: JwtCircuitParams, token: string, pk: JwkEcdsaPublicKey | PemPublicKey, matches: string[]) {
